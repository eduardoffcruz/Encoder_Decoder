...
From: https://gist.github.com/vbkaisetsu/d7c08e9c5aabe13686dd554ddfadf076
'''
import numpy as np
...
def main():
    ...
    original = np.array([1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2,1,2,3,2,1,12,2,1,23,2])
    #original = "abracadabra"
    bwt_ref, idx = bwt(original)
    encoded = [original[x] for x in bwt_ref]
    print(np.array(encoded), idx)
    ibwt_ref = ibwt(encoded, idx)
    decoded = [encoded[x] for x in ibwt_ref]
